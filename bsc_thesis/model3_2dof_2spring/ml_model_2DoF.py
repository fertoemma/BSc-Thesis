...
# Loading data
folder = 'saved_data'
fname = 'EU2_11HEAD0000H3ACX0_m3_3ch'
# fname = 'EU2_11CHST0000H3ACX0_m3_3ch'
# fname = 'EU2_11PELV0000H3ACX0_m3_3ch'
...
# plt.title(f"Validation \nEU2_11PELV0000H3ACX0_m2_3ch", fontsize=14)
# plt.title(f"Validation \nEU2_11CHST0000H3ACX0_m2_3ch", fontsize=14)
plt.title(f"Validation \nEU2_11HEAD0000H3ACX0_m2_3ch", fontsize=14)
# plt.show()
plt.savefig(os.path.join(output_dir, 'validation_EU2_11HEAD0000H3ACX0_m2_3ch.png'))
plt.savefig(os.path.join(output_dir, 'validation_EU2_11HEAD0000H3ACX0_m2_3ch.svg'))
plt.close()
...
plt.title(f"Comparison of results  \nEU2_11HEAD0000H3ACX0_m2_3ch", fontsize=14)
# plt.show()
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11HEAD0000H3ACX0_m2_3ch.png'))
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11HEAD0000H3ACX0_m2_3ch.svg'))
plt.close()