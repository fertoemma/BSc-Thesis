...
# from optuna study for 3 channels: mb_single_optuna_2dof_mod_3ch.py
k_1_opt = 6.914e+05
k_2_opt = 5.547e+05  
kt_1_opt = 5.259e+06 
...
# Save 
folder = 'saved_data'
data_saver.save(data_dict_p, folder, 'EU2_11PELV0000H3ACX0_m3_3ch')
data_saver.save(data_dict_ch, folder, 'EU2_11CHST0000H3ACX0_m3_3ch')
data_saver.save(data_dict_h, folder, 'EU2_11HEAD0000H3ACX0_m3_3ch')
