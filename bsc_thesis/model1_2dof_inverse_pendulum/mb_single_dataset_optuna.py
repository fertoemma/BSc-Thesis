...
study_name_2dof = "2dof_k_inits"
max_num_of_trials = 200 # How many iterations optuna should go through, before it picks the best parameters.
num_of_threads = 2 # How many trials should optuna run in parallel. (Shouldn't be more than the processor cores you have available.)

# All trial's parameter values will be writtin out to excel as well at the end of the optimisation.
output_excel_path = os.path.join( optuna_2dof_opt_main_dir, "trials_ch_"+study_name_2dof+".xlsx" )
