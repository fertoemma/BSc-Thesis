...
# Loading data
folder = 'saved_data'
# fname = 'EU2_11HEAD0000H3ACX0_m1_pch'
# fname = 'EU2_11PELV0000H3ACX0_m1_pch'
fname = 'EU2_11CHST0000H3ACX0_m1_pch'
...
# plt.show()
plt.savefig(os.path.join(output_dir, 'validation_EU2_11CHST0000H3ACX0_m1_pch.png'))
plt.savefig(os.path.join(output_dir, 'validation_EU2_11CHST0000H3ACX0_m1_pch.svg'))
plt.close()
...
# plt.show()
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11CHST0000H3ACX0_m1_pch.png'))
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11CHST0000H3ACX0_m1_pch.svg'))
plt.close()