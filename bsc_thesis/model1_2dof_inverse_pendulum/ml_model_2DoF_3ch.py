...
# Loading data
folder = 'saved_data'
# fname = 'EU2_11HEAD0000H3ACX0_m1_3ch'
# fname = 'EU2_11PELV0000H3ACX0_m1_3ch'
fname = 'EU2_11CHST0000H3ACX0_m1_3ch'
...
# plt.show()
plt.savefig(os.path.join(output_dir, 'validation_EU2_11CHST0000H3ACX0_m1_3ch.png'))
plt.savefig(os.path.join(output_dir, 'validation_EU2_11CHST0000H3ACX0_m1_3ch.svg'))
plt.close()
...
# plt.legend()
# plt.title(f"Comparison of simulated and trained results - {fname}")
# plt.show()
...
# plt.show()
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11CHST0000H3ACX0_m1_3ch.png'))
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11CHST0000H3ACX0_m1_3ch.svg'))
plt.close()