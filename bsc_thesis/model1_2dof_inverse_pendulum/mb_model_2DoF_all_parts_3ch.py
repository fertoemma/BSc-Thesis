...
# optuna 500 iterations for three channels
k_opt = 1.955e+04
k_t_opt = 3.94e+07 
...
# Save 
folder = 'saved_data'
data_saver.save(data_dict_p, folder, 'EU2_11PELV0000H3ACX0_m1_3ch')
data_saver.save(data_dict_ch, folder, 'EU2_11CHST0000H3ACX0_m1_3ch')
data_saver.save(data_dict_h, folder, 'EU2_11HEAD0000H3ACX0_m1_3ch')
