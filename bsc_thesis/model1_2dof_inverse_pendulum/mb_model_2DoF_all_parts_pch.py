...
# optuna 500 iterations for only pelvis channel
k_opt = 1.906e+05
k_t_opt = 4.38e+04
...
# Save 
folder = 'saved_data'
data_saver.save(data_dict_p, folder, 'EU2_11PELV0000H3ACX0_m1_pch')
data_saver.save(data_dict_ch, folder, 'EU2_11CHST0000H3ACX0_m1_pch')
data_saver.save(data_dict_h, folder, 'EU2_11HEAD0000H3ACX0_m1_pch')
