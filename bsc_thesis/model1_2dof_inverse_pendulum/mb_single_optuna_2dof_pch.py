...
# Save the computed accelerations into variables with a name index of 3ch
...
# Plotting the comparison of pch and 3ch for the x directional values of pelvis, chest, and head
...
# plt.figure()
# plt.plot(simulation_time_vals, pelvis_acceleration_simu_x, label="simulation", color='#86a542')
# plt.plot(simulation_time_vals, a_pelvis_x_combfit_pch, label="pelvis channel fit", color='#d62728')
# plt.plot(simulation_time_vals, a_pelvis_x_combfit_3ch, label="3 channel fit", color='#6881d8')
# plt.legend()
# plt.grid()
# plt.xlabel('Time [s]')
...
# plt.figure()
# plt.plot(simulation_time_vals, chest_acceleration_simu_x, label="simulation", color='#86a542')
# plt.plot(simulation_time_vals, a_chest_x_combfit_pch, label="pelvis channel fit", color='#d62728')
# plt.plot(simulation_time_vals, a_chest_x_combfit_3ch, label="3 channel fit", color='#6881d8')
# plt.legend()
# plt.grid()
# plt.xlabel('Time [s]')
# plt.ylabel('Acceleration [mm/s$^2$]', fontsize=10)
...
# plt.figure()
# plt.plot(simulation_time_vals, head_acceleration_simu_x, label="simulation", color='#86a542')
# plt.plot(simulation_time_vals, a_head_x_combfit_pch, label="pelvis channel fit", color='#d62728')
# plt.plot(simulation_time_vals, a_head_x_combfit_3ch, label="3 channel fit", color='#6881d8')
# plt.legend()
# plt.grid()
# plt.xlabel('Time [s]')
# plt.ylabel('Acceleration [mm/s$^2$]', fontsize=10)
...
k_opt_us = result.params['k']
k_t_opt_us = result.params['k_t']

result.params.pretty_print()

a_pelvis_x_combfit_us, a_pelvis_y_combfit_us, a_chest_x_combfit_us, a_chest_y_combfit_us, a_head_x_combfit_us, a_head_y_combfit_us = \
    solv.calculate_acceleration_components_for_all_body_parts(ddx_num, ddphi_num, gain_us, simulation_time_vals, y0, k_opt_us, k_t_opt_us, l)

# Save the computed accelerations into variables with a name index of us
a_pelvis_x_combfit_us_pch = a_pelvis_x_combfit_us
a_pelvis_y_combfit_us_pch = a_pelvis_y_combfit_us
a_chest_x_combfit_us_pch = a_chest_x_combfit_us
a_chest_y_combfit_us_pch = a_chest_y_combfit_us
a_head_x_combfit_us_pch = a_head_x_combfit_us
a_head_y_combfit_us_pch = a_head_y_combfit_us
...
# Save the computed accelerations into variables with a name index of 3ch_us
a_pelvis_x_combfit_3ch_us = a_pelvis_x_combfit_us
a_pelvis_y_combfit_3ch_us = a_pelvis_y_combfit_us
a_chest_x_combfit_3ch_us = a_chest_x_combfit_us
a_chest_y_combfit_3ch_us = a_chest_y_combfit_us
a_head_x_combfit_3ch_us = a_head_x_combfit_us
a_head_y_combfit_3ch_us = a_head_y_combfit_us
...
# Plotting the comparison of pch and 3ch for the x directional values of pelvis, chest, and head for both EU2 and US data
