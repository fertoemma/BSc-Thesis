...
# Loading data
folder = 'saved_data'
# fname = 'EU2_11PELV0000H3ACX0_m2_pch'
# fname = 'EU2_11CHST0000H3ACX0_m2_pch'
fname = 'EU2_11HEAD0000H3ACX0_m2_pch'
...
# plt.title(f"Validation \nEU2_11PELV0000H3ACX0_m3_pch", fontsize=14)
# plt.title(f"Validation \nEU2_11CHST0000H3ACX0_m3_pch", fontsize=14)
plt.title(f"Validation \nEU2_11HEAD0000H3ACX0_m3_pch", fontsize=14)
# plt.show()
plt.savefig(os.path.join(output_dir, 'validation_EU2_11HEAD0000H3ACX0_m3_pch.png'))
plt.savefig(os.path.join(output_dir, 'validation_EU2_11HEAD0000H3ACX0_m3_pch.svg'))
plt.close()
...
# plt.title(f"Comparison of results  \nEU2_11CHST0000H3ACX0_m3_pch", fontsize=14)
plt.title(f"Comparison of results  \nEU2_11HEAD0000H3ACX0_m3_Ppch", fontsize=14)

# plt.show()
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11HEAD0000H3ACX0_m3_pch.png'))
plt.savefig(os.path.join(output_dir, 'comparison_EU2_11HEAD0000H3ACX0_m3_pch.svg'))
plt.close()