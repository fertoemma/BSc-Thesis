...
# Values already optimized with optuna for 1 single dataset
# k_1_init_opt = 9948529.045
# k_2_init_opt = 89098322.64
# kt_1_init_opt = 34388767.48
# kt_2_init_opt = 24758175.77
y0 = np.array ([0,0,0,0,0,0])

# # Optuna 10 iterations
# k_1_opt = 9.95E+06
# k_2_opt = 8.91E+07
# kt_1_opt = 3.44E+07
# kt_2_opt = 2.48E+07

# # Optuna 68 iterations
# k_1_opt = 4.569e+07
# k_2_opt = 7.09e+04
# kt_1_opt = 6.983e+04
# kt_2_opt = 2.749e+07
# Optuna 500 iterations with 3 channels
k_1_opt = 7.587e+05
k_2_opt = 3.17e+06 
kt_1_opt = 5.155e+06
kt_2_opt = 2.238e+07
...
# Save 
folder = 'saved_data'
data_saver.save(data_dict_p, folder, 'EU2_11PELV0000H3ACX0_m2_3ch')
data_saver.save(data_dict_ch, folder, 'EU2_11CHST0000H3ACX0_m2_3ch')
data_saver.save(data_dict_h, folder, 'EU2_11HEAD0000H3ACX0_m2_3ch')
