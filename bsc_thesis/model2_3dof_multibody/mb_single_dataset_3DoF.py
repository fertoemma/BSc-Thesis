...
m_1 = 34        # kg
m_2 = 4         # kg
ddx_num, ddphi_num, ddtheta_num = solv.lagrangian_fast(m_1, m_2, l, R)   # data can be modified
...
# results of prevous optuna optimization
k_1_init_opt = 5.7660110e+07
k_2_init_opt = 4.825137e+07
kt_1_init_opt = 3.257875e+07
kt_2_init_opt = 7.119197e+07
params = Parameters()
# set up the initial parameter values
...
# Computing acceleration values using 
