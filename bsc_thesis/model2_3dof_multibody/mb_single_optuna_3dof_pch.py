...
import model2_3dof_multibody.lmfit_3dof as lmfit_3dof
...
optuna_3dof_opt_main_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "optuna_3dof_k_inits_pelv_obj")

# Define the study name
study_name = "3dof_k_inits"

# Define the storage name (path to the SQLite database)
storage_name = os.path.join(f"sqlite:///{optuna_3dof_opt_main_dir}", f"{study_name}.db")
...
kt_2_init_opt = best_init_vals['kt_2_init']
...
# Define the main directory for Optuna studies
optuna_3dof_opt_main_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "optuna_3dof_k_inits_pelv_chst_head_obj")
...
fitter = Minimizer(lmfit_3dof.combined_obj_function, params,
                   fcn_args=(ddx_num, ddphi_num, ddtheta_num, gain_us, simulation_time_vals, pelvis_acceleration_simu_x_us, chest_acceleration_simu_x_us, head_acceleration_simu_x_us, y0,R, l, channels_to_use))
result = fitter.minimize(method='least_squares')
...
a_pelvis_x_combfit, a_pelvis_y_combfit, a_chest_x_combfit, a_chest_y_combfit, a_head_x_combfit, a_head_y_combfit = \
    solv.calculate_acceleration_components_for_all_body_parts(ddx_num, ddphi_num, ddtheta_num, gain_us, simulation_time_vals, y0, k_1_opt, k_2_opt, kt_1_opt, kt_2_opt, R, l)
